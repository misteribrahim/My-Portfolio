        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-sm leading-7">
             Dedicated software engineer proficient in MERN stack development, I bring a unique blend of technical expertise and creative flair to my projects. With a strong foundation in web development, I specialize in crafting seamless user experiences and eye-catching interfaces. My passion lies in harnessing the power of technology to create innovative solutions that not only function flawlessly but also delight users visually.
            </p>
